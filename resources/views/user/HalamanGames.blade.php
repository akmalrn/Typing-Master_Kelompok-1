...
.content main .game-dashboard {
    margin-top: 36px;
}

.content main .game-dashboard .level-info {
    background: var(--light);
    border-radius: 20px;
    padding: 24px;
    margin-bottom: 24px;
...
.content main .game-dashboard .level-info h2 {
    font-size: 24px;
    font-weight: 600;
    color: var(--dark);
    margin-bottom: 16px;
...
.content main .game-dashboard .progress-bar {
    width: 100%;
    height: 12px;
    background: var(--grey);
    border-radius: 6px;
...
.content main .game-dashboard .progress {
    height: 100%;
    background: var(--primary);
    border-radius: 6px;
}

.content main .game-dashboard span {
    font-size: 14px;
    color: var(--dark-grey);
}
.level-buttons {
...
.level-button {
    padding: 12px 24px;
    background-color: var(--primary); /* Adjust to your design */
    color: var(--light); /* Adjust to your design */
    border: none;
    border-radius: 8px;
    cursor: pointer;
    font-size: 16px;
...
.level-button:hover {
    background-color: var(--dark-primary); /* Adjust to your design */
}
